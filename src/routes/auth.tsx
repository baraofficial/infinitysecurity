    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] px-4 font-mono">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center text-center">
          <img src={logo.url} alt="Bara AI logo" className="h-24 w-24 animate-spin-logo" />
          <h1 className="mt-6 text-2xl text-[#ef4444] tracking-[0.3em]">BARA AI</h1>
        </div>
        <div className="rounded-2xl border border-[#ef4444]/40 bg-[#12121a] p-6 sm:p-8">
          <p className="text-center text-[#ef4444] tracking-widest text-sm mb-6">Sign in with</p>
          <button
            type="button"
            onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-2 border border-[#ef4444]/50 hover:border-[#ef4444] hover:bg-[#ef4444]/10 text-[#ef4444] py-3 tracking-widest text-xs transition rounded-full"
          >
