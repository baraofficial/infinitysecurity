      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-[#a855f7]/40 bg-[#12121a] p-6 sm:p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-[#a855f7]/50 hover:border-[#a855f7] hover:bg-[#a855f7]/10 text-[#a855f7] py-3 tracking-widest text-xs transition rounded-full"
          >
