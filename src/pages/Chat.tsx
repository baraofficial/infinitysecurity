...
import { sendMessageToGemini } from '@/lib/gemini'; // PENTING: ini buat baca system prompt
...
export default function Chat() {
  ...
  const handleSend = async () => {
    ...
    try {
      // Format buat Gemini. Penting: assistant harus jadi 'model'
      const history = newMessages.map((m) => ({
        role: m.role === 'user'? 'user' : 'model',
        parts: [{ text: m.content }]
      }));

      // Ini yg otomatis ambil systemPrompt dari Settings
